...
const cards = [
    {id: 1, icon: 'blog', header: 'Always dreamt of having a blog and being recognizable? - With a website you can achieve it!'},
    ...
    {id: 3, icon: 'portfolio', header: 'Need a portfolio website to show your business and be competitive on the job market? - I can create a website that will bring your company to the next level!'},
