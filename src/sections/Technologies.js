...
const Designing = [
    ...
    {id: 2,
        ...
        paragraphPL: 'Figma pozwala mi na zaprezentowanie Tobie projektu designu. Dzięki temu ty także możesz uczestniczyć w pracach.'
    },
    {id: 3,
        icon: 'tailwind',
        header: 'Tailwind',
...
const Programming = [
    ...
    {id: 4,
        ...
        paragraphPL: 'Używam jednego z bardziej popularnych i niezawodnych rozwiązań serverless, które umożliwia mi zbudowanie wszystkiego od Bloga po Messenger.'
    }
]
    ...
    return(
        <section className={styles.container} ref={containerRef}>
            ...
            <div className={styles.cards}>
                <CardRow cards={cards} isVisible={isVisible} centered={true}/>
            </div>
        </section>
    )
}
